...
import { type ModelInfo, useStore } from "../store";
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 text-xs mb-3">
        {[
          {
            k: "Active params",
            v: meta.active_params_b != null ? `${meta.active_params_b}B` : "—",
          },
          {
            k: "Total params",
            v: meta.total_params_b != null ? `${meta.total_params_b}B` : "—",
          },
          {
            k: "VRAM @ Q4",
            v: meta.vram_q4_gb != null ? `${meta.vram_q4_gb} GB` : "—",
          },
          { k: "Speed", v: `~${meta.est_toks} tok/s` },
          {
            k: "Context",
            v: meta.context_k != null ? `${meta.context_k}K` : "—",
          },
      ...
      {/* Notes */}
      <div className="text-xs text-zinc-500 border-t border-zinc-800/80 pt-2">
        {meta.notes}
      </div>
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-5 p-3 rounded-lg border border-zinc-800 bg-zinc-900/30 text-xs text-zinc-500">
        All models are tested on RTX 4090 (24 GB VRAM). Gemma 4 26B-A4B and
        Qwen3.5 35B-A3B are the primary recommendations — both run at Q4 with
        significant VRAM headroom, leaving room for KV cache on long agentic
        sessions. GLM-5 and Qwen3-Coder-Next are tracked but require Ollama tags
        to drop.
      </div>
