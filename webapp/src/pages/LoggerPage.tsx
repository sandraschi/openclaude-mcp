            ...
            <div className="space-y-0.5">
              {systemLogs.map((line, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={`${color} whitespace-pre-wrap break-all border-l-2 border-transparent hover:border-zinc-800 hover:bg-zinc-900/30 px-2 transition-colors`}
                  >
                    {line}
                  </div>
                );
