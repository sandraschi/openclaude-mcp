    ...
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-zinc-500 mt-0.5">
          MCP backend and inference configuration
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 text-xs">
            <div className="bg-zinc-950 rounded-lg p-3 border border-zinc-800">
              ...
              <code className="text-amber-300 font-mono">
                D:\Dev\repos\openclaude-mcp\start.bat
              </code>
            </div>
            <div className="bg-zinc-950 rounded-lg p-3 border border-zinc-800">
              <div className="text-zinc-500 mb-1">
                From fleet starts/ folder
              </div>
              <code className="text-amber-300 font-mono">
                D:\Dev\repos\mcp-central-docs\starts\openclaude-mcp-start.bat
              </code>
            </div>
          </div>

          <div className="text-sm font-medium text-zinc-200 mt-4 mb-3">
            Backend endpoints
          </div>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
          ...
          <div className="text-xs text-zinc-500 mb-3">
            Add to{" "}
            <code className="text-zinc-400">claude_desktop_config.json</code> to
            use this MCP server from Claude Desktop:
          </div>
      ...
      "env": {
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
          ...
          <div className="text-xs text-zinc-500 mb-3">
            ...
            environment to enable. Planning runs remotely; execution stays
            local.
          </div>
          <div
            className="text-xs text-amber-500/80 border border-amber-500/20 bg-amber-500/5
        ...
        <div className="rounded-xl border border-zinc-800/60 bg-zinc-900/20 p-4">
          ...
          <div className="text-xs text-zinc-600 space-y-1">
            <div>
              OpenClaude is derived from the Anthropic Claude Code source (March
              31 2026 npm leak).
            </div>
            <div>
              Anthropic has issued DMCA notices against direct mirrors.
              Clean-room forks not targeted as of April 2026.
            </div>
            <div>
              This MCP server (openclaude-mcp) is original code — MIT license.
            </div>
            <div>
              Personal/research use is low-risk. Corporate deployment warrants
              legal review.
            </div>
          </div>
        </div>
