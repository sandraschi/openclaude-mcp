...
const BACKEND_NAME: &str = "openclaude-mcp-backend.exe";
const BACKEND_PORT: u16 = 10932;
const BACKEND_TAG: &str = "openclaude-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "OPENCLAUDE_MCP_PORT";
const ENV_HOST: &str = "OPENCLAUDE_MCP_HOST";
const ENV_TAURI: &str = "OPENCLAUDE_MCP_TAURI";
