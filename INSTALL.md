...
4. Start the server:
   ...
   uv run python -m openclaude_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn openclaude_mcp.server:app --port 10932
   ```
...
5. Open `http://localhost:10932` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/openclaude-mcp/issues) |
